...
public class MyCctvAdapter extends RecyclerView.Adapter<MyCctvAdapter.ViewHolder> {

    private List<Cctv.ListBean> list;
    private Context context;
    private OnClickListener onClickListener;

    public MyCctvAdapter(Context context, List<Cctv.ListBean> list) {
